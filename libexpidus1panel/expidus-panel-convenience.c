 ...
 * to help developers of Expidus Panel plugins.
 **/

/**
 * expidus_panel_create_button:
 *
 * Create regular #GtkButton with a few properties set to be useful in the
 * Expidus panel: Flat (%GTK_RELIEF_NONE), no focus on click and minimal padding.
 *
 * Returns: (transfer full): newly created #GtkButton.
 **/
GtkWidget *
expidus_panel_create_button (void)
{
  ...
  gtk_widget_set_name (button, "expidus-panel-button");
  ...
  gtk_css_provider_load_from_data (provider, ".expidus1-panel button { padding: 1px; }", -1, NULL);
...
/**
 * expidus_panel_create_toggle_button:
 *
 ...
 **/
GtkWidget *
expidus_panel_create_toggle_button (void)
{
  GtkStyleContext *context;
  GtkCssProvider  *provider;
  ...
  gtk_button_set_relief (GTK_BUTTON (button), GTK_RELIEF_NONE);
  gtk_widget_set_focus_on_click (GTK_WIDGET (button), FALSE);
  gtk_widget_set_name (button, "expidus-panel-toggle-button");
 ...
 *
 * Function for the name of the Esconf channel used by the panel. By default
 * this returns "expidus1-panel", but you can override this value with the
 * environment variable EXPIDUS_PANEL_CHANNEL_NAME.
 *
 * Returns: name of the Esconf channel
 *
 * See also: EXPIDUS_PANEL_CHANNEL_NAME,
 *           expidus_panel_plugin_esconf_channel_new and
 *           expidus_panel_plugin_get_property_base
 *
 * Since: 4.8
 **/
const gchar *
expidus_panel_get_channel_name (void)
{
  static const gchar *name = NULL;

  if (G_UNLIKELY (name == NULL))
    {
      name = g_getenv ("EXPIDUS_PANEL_CHANNEL_NAME");
 ...
 *
 * See also: ExpidusPanelImage
 *
 * Since: 4.10
 **/
GdkPixbuf *
expidus_panel_pixbuf_from_source_at_size (const gchar  *source,
 ...
 *
 * See expidus_panel_pixbuf_from_source_at_size
 *
 * Returns: (transfer full): a GdkPixbuf or %NULL if nothing was found. The value should
 *          be released with g_object_unref when no longer used.
 *
 ...
 **/
GdkPixbuf *
expidus_panel_pixbuf_from_source (const gchar  *source,
                               GtkIconTheme *icon_theme,
                               gint          size)
{
  return expidus_panel_pixbuf_from_source_at_size (source, icon_theme, size, size);
}



#define __EXPIDUS_PANEL_CONVENIENCE_C__
