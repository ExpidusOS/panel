...
export TEXTDOMAIN="expidus1-panel"
...
case "$1" in
  -h|--help)
    ...
    ;;
  -V|--version)
    exec @bindir@/expidus1-panel -V "$(basename $0)"
    exit 0
    ;;
  -p|--pointer)
    ATPOINTER="true"
...
@bindir@/expidus1-panel --plugin-event=applicationsmenu:popup:bool:$ATPOINTER || xfdesktop --menu
