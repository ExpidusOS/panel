...
#define EXPIDUS_TYPE_SN_CONFIG            (sn_config_get_type ())
#define EXPIDUS_SN_CONFIG(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), EXPIDUS_TYPE_SN_CONFIG, SnConfig))
#define EXPIDUS_SN_CONFIG_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), EXPIDUS_TYPE_SN_CONFIG, SnConfigClass))
#define EXPIDUS_IS_SN_CONFIG(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), EXPIDUS_TYPE_SN_CONFIG))
#define EXPIDUS_IS_SN_CONFIG_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), EXPIDUS_TYPE_SN_CONFIG))
#define EXPIDUS_SN_CONFIG_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), EXPIDUS_TYPE_SN_CONFIG, SnConfigClass))
